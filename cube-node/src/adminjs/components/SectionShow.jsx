...
const BLOCK_TYPE_FIELDS = {
  ...
  'servicesHeroSection': { label: 'Services Hero Section', fields: ['heading', 'highlightedWord', 'backgroundImage', 'featuredResources'] },
  'servicesOfferedSection': { label: 'Services Offered Section', fields: ['heading', 'highlightedWord', 'description', 'bannerImage', 'services'] },
